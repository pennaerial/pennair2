'''
This code is not the work of Penn Aerial Robotics, but the utm package from Tobias Bieniek (MIT License)
'''
...
# Code below is from  the utm python open source library.
